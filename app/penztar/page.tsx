          ...
          <div className="lg:col-span-3 space-y-12">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4">
                <input required name="name" placeholder="Név" onChange={handleChange} className="w-full h-14 bg-white border rounded-2xl px-5 outline-none font-medium focus:border-[#e3936e] transition-colors" />
              </div>
